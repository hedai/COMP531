      ...
      <div className="col-sm-11">
        ...
        <div className="row">
          <div className="col-sm-9">
            ...
            <ContentEditable className="media-body article-text" html={this.props.text}
              contentEditable={this.props.username == this.props.author} id="articleTextArea"
        ...
        <div className="btn-group btn-group-justified">
          <div className="btn-group">
            <label className="btn btn-primary" id="showCommentBtn"
              onClick={() => {
          ...
          <div className="btn-group">
            <label className="btn btn-primary" id="addCommentBtn"
